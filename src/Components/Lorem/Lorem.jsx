    ...
    <div className="bg-[#F0F0F0] py-[60px] md:py-[130px] font-poppins">
      <Container>
        <div className=" md:flex md:justify-between">
             ...
             <div className="z-[1] relative bg-[url(./assets/man.png)] bg-no-repeat bg-cover py-[20px] md:py-[75px] md:px-[44px] px-[50px] w-fit  mt-[20px]">
          ...
          {/* ---------------------------------------------------------------------------------- */}
          <div className="z-[1] relative bg-[url(./assets/woman.png)] bg-no-repeat bg-cover py-[20px] md:py-[75px] md:px-[44px] px-[50px] w-fit  mt-[20px]">
            <div className=" z-[-1] absolute bg-black/50 w-full h-full top-0 left-0"></div>
          ...
          <div className="z-[1] relative bg-[url(./assets/iron.png)] bg-no-repeat bg-cover py-[20px] md:py-[75px] md:px-[44px] px-[50px] w-fit  mt-[20px]">
            <div className=" z-[-1] absolute bg-black/50 w-full h-full top-0 left-0"></div>
